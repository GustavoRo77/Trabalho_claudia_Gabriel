...
import {
  ...
  l,
  m
} from "./chunk-LOP6ZS6W.js";
import {
  c,
  t,
  u
} from "./chunk-WIC7X2U7.js";
import "./chunk-WTZ33AFN.js";
...
var D = async (o2, n, r, a2, e, s, d2 = false, c2 = 0, l3 = true) => {
  if (!r && !a2) return;
  ...
  if (u2(o2, n, true, f2.inputSafeY, d2), v(n), s && r && (y = f2.scrollPadding, h(r, y)), "undefined" != typeof window) {
    let a3;
    const e2 = async () => {
      void 0 !== a3 && clearTimeout(a3), window.removeEventListener("ionKeyboardDidShow", d3), window.removeEventListener("ionKeyboardDidShow", e2), r && await m(r, 0, f2.scrollAmount, f2.scrollDuration), u2(o2, n, false, f2.inputSafeY), document.activeElement === n && v(n), s && b(n, r, (() => y = 0));
    }, d3 = () => {
...
var x = async (t3, i2) => {
  if (void 0 === o) return;
  const l3 = "ios" === i2, f2 = "android" === i2, w2 = t3.getNumber("keyboardHeight", 290), m3 = t3.getBoolean("scrollAssist", true), h2 = t3.getBoolean("hideCaretOnScroll", l3), b2 = t3.getBoolean("inputBlurring", false), y2 = t3.getBoolean("scrollPadding", true), v2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), M = await t2.getResizeMode(), j = async (n) => {
    await new Promise(((o2) => t(n, o2)));
...
@ionic/core/components/p-DmzFY5IC.js:
   ...
   *)
*/
//# sourceMappingURL=p-DmzFY5IC-N55AUT46.js.map
