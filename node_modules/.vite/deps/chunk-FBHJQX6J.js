...
var h = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-DX5m9g56-4F7VYDRX.js")).iosTransitionAnimation : (await import("./p-Dw7GNDKq-FU7HRRUB.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
  const i2 = n3(e.baseEl, e);
  C(e.enteringEl, e.leavingEl);
  const a = await j(i2, e);
...
var P2 = async (e) => {
  ...
  return await k(e, o), C(i2, a), V(i2, a), { hasCompleted: true };
};
var k = async (n3, e) => {
  (void 0 !== n3.deepWait ? n3.deepWait : e) && await Promise.all([M(n3.enteringEl), M(n3.leavingEl)]), await D(n3.viewIsReady, n3.enteringEl);
};
var D = async (n3, e) => {
  n3 && await n3(e);
};
...
@ionic/core/components/p-BDd9Zrb9.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-FBHJQX6J.js.map
